...
public class ModelTracker extends AbstractTracker
{
     ...
     *  <li>A Java system property prefixed with solr.</li>
     *  <li>OS environment variable</li>
     * </ol>
     *
     * @return A property value or the default
     */
    private static String locateProperty(String propertyName, String defaultValue)
    {
        // Try system property
        ...
        // Try system property with solr. prefix
        propertyValue = System.getProperty("solr." + propertyName);
        if (propertyValue != null)
        {
            return propertyValue;
        }
        ...
        String envVar = "SOLR_" + propertyName.replace('.', '_').toUpperCase();

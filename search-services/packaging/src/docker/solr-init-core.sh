#!/bin/sh
# Script to create the alfresco core if it doesn't exist
# Used as a Docker entrypoint wrapper

SOLR_HOME="/opt/alfresco-search-services/solrhome"
CORE_NAME="${SOLR_CREATE_ALFRESCO_DEFAULTS:-alfresco}"
TEMPLATE="${SOLR_TEMPLATE:-rerank}"
DATA_DIR="/opt/alfresco-search-services/data"

# Create core directory from template if it doesn't exist
